...
class Agent(object):
    ...
    def load_model(self,PATH='/SAC_checkpoint.pt'):
      ...
      self.buffer_counter = checkpoint['buffer_counter']
      self.state_buffer = checkpoint['state_buffer']
      self.reward_buffer = checkpoint['reward_buffer']
      self.action_buffer = checkpoint['action_buffer']
      self.next_state_buffer = checkpoint['next_state_buffer']
      self.terminal_buffer = checkpoint['terminal_buffer']

      print("#########################################################")
      print("Episodes:",self.episodes)
      print("Log_Alpha:",self.log_alpha)
      print("Learn_Counter:",self.learn_counter)
      print("Buffer_Counter:",self.buffer_counter)
      print("sum_reward_buffer:",np.sum(self.reward_buffer))
      print("#########################################################")
